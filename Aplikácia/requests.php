...
$sql = $conn->query("SELECT id, user_id, date_time, from_time, to_time, description, type, confirmation,
                    ...
                    HAVING user_status > 0 ORDER BY date_time desc");
...
while ( $r = $sql->fetch_assoc() ) {
  ...
  $class = "disable";
  if ( $r["confirmation"] ) $class = "enable";

  $str .= print_requests_table_row ( $r["id"], sk_format_date( $r['date_time'] ), $time, $user_name, $sk_types[$r["type"]], $r["description"], $class );
}
if ( !$str )
